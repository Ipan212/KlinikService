            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="nama_jespem" class="col-lg-2 col-lg-offset-1 control-label">Jenis Pemeriksaan</label>
                        <div class="col-lg-6">
                            <input type="text" name="nama_jespem" id="nama_jespem" class="form-control" required autofocus>
