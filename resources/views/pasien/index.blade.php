      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <button onclick="addForm('{{route('pasien.store')}}')" class="btn btn-success btn-xs btn-flat rounded-lg"><i class="fas fa-plus-circle"> Tambah</i></button>
            <button onclick="cetakPasien('{{ route('pasien.cetak_pasien') }}')" class="btn btn-info btn-xs btn-flat"><i class="fa fa-id-card"></i> Cetak Kartu Pasien</button>
        </div>
          <!-- /.card-header -->
